...
// =================================================================
// CONTROLADOR CENTRAL DE TEMA (MODO OSCURO / CLARO)
// =================================================================
...
document.addEventListener("DOMContentLoaded", () => {
    function actualizarImagenesTema() {
        ...
        if (logo) {
            logo.src = temaActual === "dark" ? "img/logodark.svg" : "img/logod.svg";
        }
        const banner = document.getElementById("banner-memoria");
        if (banner) {
            banner.src = temaActual === "dark" ? "img/banner_dm.svg" : "img/banner_lm.svg";
        }
    }

    const htmlElement = document.documentElement; 
    
    // 1. ¿Qué modo aplicamos?
...
document.addEventListener("click", (e) => {
    ...
    if (btnTema) {
        ...
        const logo = document.getElementById("logo-navbar");
        if (logo) {
            logo.src = nuevoTema === "dark" ? "img/logodark.svg" : "img/logod.svg";
        }
        const banner = document.getElementById("banner-memoria");
        if (banner) {
            banner.src = nuevoTema === "dark" ? "img/banner_dm.svg" : "img/banner_lm.svg";
        }
        
        const icono = btnTema.querySelector("i");
        if (icono) {
            icono.className = nuevoTema === "dark" ? "fa-solid fa-sun" : "fa-solid fa-moon";
        }
